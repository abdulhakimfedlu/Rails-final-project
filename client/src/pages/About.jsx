  ...
  const sections = [
    {
      ...
      content:
        "Under the soft morning light of Ethiopia's highlands, there grows a special coffee bean that tells an old, proud story.",
      image:
    ...
    },
    {
      ...
      content:
        'Long ago in the forests of Yayu, wild coffee plants grew free and strong. A young goat herder named Kaldi noticed his goats became lively after eating bright red berries.',
      image:
    ...
    },
    {
      ...
      content:
        'Curious, he tasted one too—and felt a spark of energy and joy. This moment changed the world forever, giving birth to the coffee culture we cherish today.',
      image:
    ...
    },
    {
      ...
      content:
        'Today at Akaka Coffee, we keep that spark alive. Our beans come from small farms in Sidama and Kafa, where families pick each cherry by hand.',
      image:
    ...
    },
    {
      ...
      content:
        'When you visit Akaka Coffee, you join an old celebration called the coffee ceremony. We roast green beans in a flat pan over charcoal, then grind them fresh and brew in a clay pot called a jebena.',
      image:
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50">
      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              'url(https://images.unsplash.com/photo-1545665225-b23b99e4d45e?w=1920&h=1080&fit=crop)',
              ...
              {[
                {
                  flavor: 'Sweet Honey',
                  icon: '🍯',
                  description: 'Natural sweetness from highland flowers',
                },
                {
                  flavor: 'Soft Jasmine',
                  icon: '🌸',
                  description:
                    'Delicate floral notes that dance on your palate',
                },
                {
                  flavor: 'Berry Hint',
                  icon: '🫐',
                  description: 'Subtle fruit undertones from wild berries',
                },
              ].map((item, index) => (
                <div
                  key={index}
                ...
                >
                  ...
                  <p className="text-orange-200 font-light">
                    {item.description}
                  </p>
                </div>
              ))}
