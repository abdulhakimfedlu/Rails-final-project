...
const Home = () => {
  ...
  const coffeeSteps = [
    {
      ...
      description:
        'Our farmers wake before sunrise to hand-select only the ripest coffee cherries at peak flavor',
      icon: Sun,
    ...
    },
    {
      title: 'Washed & Sorted',
      description:
        'Each cherry is carefully washed and sorted by hand, ensuring only the finest beans make it through',
      icon: Droplets,
    ...
    },
    {
      title: 'Slow Roasted',
      description:
        "Small batches roasted to perfection in our traditional roasters, bringing out each bean's unique character",
      icon: Thermometer,
    ...
    },
    {
      title: 'Served Fresh',
      description:
        'Ground moments before brewing, ensuring you experience the full complexity of flavors in every cup',
      icon: Coffee,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-amber-50 to-orange-50 text-stone-800 overflow-hidden relative">
      ...
      <section
        ref={heroRef}
        className="relative h-[90vh] min-h-[600px] flex items-center justify-center overflow-hidden pt-36 md:pt-24"
      >
        ...
        <div className="absolute inset-0">
          ...
          />
          <div
            className={`absolute inset-0 bg-gradient-to-br ${timeBasedGradient[timeOfDay]} opacity-20`}
          />
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto py-12">
          ...
          <div className="mb-8 inline-flex items-center space-x-3 bg-white/20 backdrop-blur-xl px-8 py-4 rounded-full border border-white/30 shadow-xl">
            ...
            <span className="text-sm font-medium text-white">
              Addis Ababa's Premier Coffee Experience
            </span>
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            <span className="block text-white drop-shadow-2xl">Akaka</span>
          ...
          <p className="text-base md:text-lg text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed font-light">
            Where tradition meets innovation. Experience the rich heritage of
            Ethiopian coffee culture with our carefully sourced and expertly
            roasted premium beans.
          </p>
            ...
            {[
              ...
              <div key={index} className="group">
                <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                  <stat.icon
                    className={`h-10 w-10 ${stat.color} mx-auto mb-4 group-hover:scale-110 transition-transform`}
                  />
      ...
      <section className="py-20 relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-stone-800 mb-16">
      ...
      <section className="py-20 relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Join thousands of coffee lovers who have discovered the perfect cup.
      ...
      <div className="py-20 bg-gradient-to-br from-amber-100 to-orange-100">
        <div className="container mx-auto px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto font-light">
            Welcome to Akaka Coffee. Drink a cup, feel the highland breeze, and
